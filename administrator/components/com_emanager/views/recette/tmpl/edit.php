	...
	<div class="row-fluid">
		...
		<fieldset>
			<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>
				...
				<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', empty($this->item->id) ? JText::_('COM_EMANAGER_FIELDSET_RECETTE_FORM', true) : JText::sprintf('COM_EMANAGER_FIELDSET_RECETTE_FORM', $this->item->id, true)); ?>
