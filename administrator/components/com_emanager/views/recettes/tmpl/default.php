...
<form action="<?php echo JRoute::_('index.php?option=com_emanager&view=recettes'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="table table-striped" id="articleList">
		...
		<tbody>
			...
			foreach ($this->items as $i => $item) :
				$canEdit	= $user->authorise('core.edit',       'com_emanager.recette.'.$item->id);
				$canChange = $user->authorise('core.edit.state',	'com_emanager');
			?>
				<tr class="row<?php echo $i % 2; ?>" sortable-group-id="recettes_ordering">
					<td class="center hidden-phone">
						<?php echo JHtml::_('grid.id', $i, $item->id); ?>
					</td>		
					<td class="center">
						<div class="btn-group">
							<?php echo JHtml::_('jgrid.published', $item->published, $i, 'recettes.', $canChange, 'cb'); ?>
						</div>
					</td>							
					<td class="nowrap has-context">
						<div class="pull-left">
							<?php if ($canEdit) : ?>
								<a href="<?php echo JRoute::_('index.php?option=com_emanager&task=recette.edit&id='.(int) $item->id); ?>">
					...
					<td align="center hidden-phone">
						<span class="recette-icn <?php echo $item->icon; ?>"></span>
					</td>					
					<td align="center hidden-phone">
