...
<form action="<?php echo JRoute::_('index.php?option=com_emanager&view=categories'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="table table-striped" id="articleList">
		...
		<tbody>
			...
			foreach ($this->items as $i => $item) :
				$canEdit	= $user->authorise('core.edit',       'com_emanager.categorie.'.$item->id);
				$canChange = $user->authorise('core.edit.state',	'com_emanager');
			?>
				<tr class="row<?php echo $i % 2; ?>" sortable-group-id="categories_ordering">
					...
					<td class="nowrap has-context">
						<div class="pull-left">
							<?php if ($canEdit) : ?>
								<a href="<?php echo JRoute::_('index.php?option=com_emanager&task=categorie.edit&id='.(int) $item->id); ?>">
					...
					<td align="center hidden-phone">
						<span class="categorie-icn <?php echo $item->icon; ?>"></span>
					</td>					
					<td align="center hidden-phone">
